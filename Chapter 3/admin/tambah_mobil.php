...
<head>
    ...
    <title>Transportasi | Tambah Transportasi</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Form Tambah Transportasi</h5>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="tahun_pembuatan" placeholder="Kapasitas" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
