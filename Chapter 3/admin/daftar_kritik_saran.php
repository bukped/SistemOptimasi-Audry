					                    ...
					                    <tbody>
						                    ...
						                    <tr>
						                        ...
						                        <td>
                                                    ...
                                                    <button class="btn btn-danger dim" onclick="if (confirm('Data catatan akan dihapus, apakah Anda yakin?')) location.href='<?php echo site_url('daftar_kritik_saran/hapus_kritik_saran/'.$dks['id_kritik_saran'])?>'" type="button"><i class="fa fa-trash"></i> </button>
                                                    </div>
						                        </td>
						                    </tr>
						                    <?php } ?>
