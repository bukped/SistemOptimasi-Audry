	                                ...
	                                <div class="table-responsive">
					                    ...
					                    <tbody>
						                    ...
						                    <tr>
						                        ...
						                        <td><?php echo $dt['id_jenis_mobil'] == NULL ? '<span class="badge badge-warning">On Process</span>' : $dt['plat_nomor']; ?></td>
                                                ...
                                                <td><?php echo $dt['id_transaksi'] == NULL ? '<span class="badge badge-warning">Process</span>' : $dt['biaya']; ?></td>
						                        <td>
						                        	<center>
						                            <?php 
						                                if($dt['status'] == 0){
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <button class="btn btn-info btn-circle" type="button"><i class="fa fa-bus"></i></button> : Sedang Dalam Proses Pengiriman
                                </div>
                                <div class="col-sm-4">
                                    <button class="btn btn-primary btn-circle" type="button"><i class="fa fa-check"></i></button> : Selesai
                                </div>
                            </div>
                        </div>
                    </div>
