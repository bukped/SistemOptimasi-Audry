...
<head>
    ...
    <title>Transportasi | Detail Transaksi</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12 form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <p class="form-control-static"><?php echo $t['tanggal_expired']; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Nama Transportasi :</label>
                                        <div class="col-lg-9">
                                            <p class="form-control-static"><?php echo $t['id_mobil'] == NULL ? '<span class="badge badge-warning"></span>' : $t['plat_nomor']; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <p class="form-control-static"><?php echo $t['id_mobil'] == NULL ? '<span class="badge badge-warning"></span>' : $t['biaya']; ?></p>
                                        </div>
                                    </div>
