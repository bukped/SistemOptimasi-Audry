...
<head>
    ...
    <title>Transportasi | Daftar Transportasi</title>
        ...
        <div class="wrapper wrapper-content">
            <div class="row">
                <div class="col-lg-3" style="margin: 0px 10px; text-transform: none;">
                    <button class="btn btn-primary btn-rounded btn-block dim" style="text-transform: none;" type="button" onclick="location.href='<?php echo site_url('daftar_mobil/tambah_mobil')?>'"><i class="fa fa-plus"></i> Tambah Transportasi</button>
                </div>
                <div class="col-lg-8">
	                                ...
	                                <div class="table-responsive">
					                    ...
					                    <tbody>
						                    ...
						                    <tr>
                                                ...
                                                <td><?php echo $dm['status_mobil'] == 1 ? '<span class="badge badge-danger">Ready</span>' : '<span class="badge badge-primary">Ready</span'; ?></td>
						                        <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button class="btn btn-danger dim" onclick="if (confirm('Data Transportasi akan dihapus, apakah Anda yakin?')) location.href='<?php echo site_url('daftar_mobil/hapus_mobil/'.$dm['id_mobil'].'/'.$dm['foto_mobil'].'/'.$dm['thumbnail_mobil'])?>'" type="button"><i class="fa fa-trash"></i> </button>
                                                    </div>
						                        </td>
						                    </tr>
						                    <?php } ?>
