...
<head>
    ...
    <title>Transportasi | Edit Pengiriman</title>
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><button type="button" class="btn btn-s btn-danger" <?php if($x == 1) echo 'disabled'; ?> onclick="if (confirm('Barang akan dihapus, apakah Anda yakin?')) location.href='<?php echo site_url('transaksi/hapus_barang_transaksi/'.$db['id_daftar_barang'].'/'.$t['id_transaksi'])?>'" ><i class="fa fa-trash"></i></button></center>
                                                    </td>
                                                </tr>
