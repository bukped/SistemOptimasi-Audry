...
<head>
    ...
    <title>Transportasi | Tambah Catatan</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
	                            <div class="col-lg-12">
	                                <form class="form-horizontal" role="form" action="<?php echo site_url('kritik_saran/tambah_kritik_saran_form')?>" method="post" onsubmit="return confirm('Catatan akan dikirim. Apakah Anda yakin?');">
